...
<div>
    ...
    <br /><br /><br />
    <p id="Careers_tex33">Current Positions</p>
    <br /><br /><br />

    <div class="container row m-auto gap-4">

        <div class="hidddenright" id="career_card99">
            <p>SECTION</p>
            <h1>Job Title </h1>
            <p>LOCATION</p>
            <br><br>
            <button id="apply_btn434">Apply</button>

        </div>

        <div class="hidddenleft" id="career_card99">
            <p>SECTION</p>
            <h1>Job Title </h1>
            <p>LOCATION</p>
            <br><br>
