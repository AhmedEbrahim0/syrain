...
<html lang="en">
  ...
  <body>
    ...
    <div>
      <div class="container">
        <a href="/Products/{{$product->category_id}}" id="pro_back_btn">
          <img
            src="/images/vuesax-boldgg-vuesax-bold-arrow-left.svg"
            alt=""
          />
          <p class="mt-3">BACK TO PRODUCTS</p>
        </a>
        <div id="product_detailes_sec" class="row align-items-center m-auto">
          <div class="hidddenright col-lg-6 col-md-5 col-12">
            <h1>{{$product->name}}</h1>
            <p> {{$product->text}} </p>
            <h5>{{$product->detials}}</h5>
          </div>

          <div class="hidddenleft col-lg-6 col-md-7 col-12">
