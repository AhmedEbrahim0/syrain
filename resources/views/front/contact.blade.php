...
<div class="hidddenright col-lg-6 col-md-6 col-sm-12 col-12 ">
    <img 
    id="contact_img313"
    src="/images/image-placeholdergdgdfghdh.png" alt="">
</div>
...
<div class="hidddenleft col-lg-6 col-md-6 col-sm-12 col-12 ">
    ...
    <h1>Get in touch today</h1>
         <form method="post" action="Contact" >
          @csrf
            <input id="Name_Input"  name="name" type="text" placeholder="Name"><br><br>
            <input id="Email_Input" name="email"  type="email" placeholder="Email"><br><br>
            <input id="Mass_Input"  name="message" type="text" placeholder="Please type your message here..."><br><br>
