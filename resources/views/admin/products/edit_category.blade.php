		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				<div class="title pb-20">
					<h2 class="h3 mb-0"> Add Category</h2>
				</div>
				...
				<div class="bg-white p-2">
                    ...
                    <form action="/admin/update-category" enctype="multipart/form-data" method="post">
                        @csrf

                        <input type="text" name="id" value="{{$category->id}}" hidden>
                        <div>
                            <textarea class="textarea" name="name" placeholder="category Name">{{$category->name}}</textarea>
                        </div>
                        <div>
                            ...
                            <img src="/{{$category->image}}" id="output_image" style="height: 150px; width:150px"  alt="">
                        </div>
                        <div>
