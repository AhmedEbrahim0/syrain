		...
		<div class="main-container">
			<div class="xs-pd-20-10 pd-ltr-20">
				...
				<div class="bg-white p-2">
                    ...
                    <form action="/admin/update-product" enctype="multipart/form-data" method="post">
                        @csrf

                        <input type="text" name="id" value="{{$product->id}}" hidden>
                        <div>
                            <textarea class="textarea" name="name" placeholder="Product Name">{{$product->name}}</textarea>
                        </div>
                        <div>
                            <textarea class="textarea" name="text" placeholder="Description ">{{$product->text}}</textarea>
                        </div>
                        <div class="my-2">
