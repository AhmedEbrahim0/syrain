				...
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="/admin/home-backgound">Background</a></li>
								<!-- <li><a href="/admin/home-products">Products</a></li>
								<li><a href="/admin/home-recipes">Recipes</a></li> -->
								<li><a href="/admin/home-map">Map</a></li>
							</ul>
						</li>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								...
								<li><a href="/admin/add-recipes">Add Recipes</a></li>
							</ul>
						</li>
						...
						<li class="dropdown">
							...
							<ul class="submenu">
								<li><a href="/admin/about-us">section 1 </a></li>
								<li><a href="/admin/aboutus">section 2 </a></li>
							</ul>
						</li>
						<li class="dropdown">
							<a  class="dropdown-toggle">
